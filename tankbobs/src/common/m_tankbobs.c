...
static const struct luaL_Reg tankbobs[] =
{
	...
	{"io_toDouble", io_toDouble}, /* returns the number generated by the first eight bytes of the string passed */
		/* The arguments are not checked */
	{"io_fromInt", io_toInt}, /* returns the string generated by the first four bytes of the integer passed */
		/* The arguments are not checked */
	{"io_fromShort", io_toShort}, /* returns the string generated by the first two bytes of the integer passed */
		/* The arguments are not checked */
	{"io_fromChar", io_toChar}, /* returns the string generated by the first byte of the integer passed */
		/* The arguments are not checked */
	{"io_fromFloat", io_toFloat}, /* returns the string generated by the first four bytes of the number passed */
		/* The arguments are not checked */
	{"io_fromDouble", io_toDouble}, /* returns the string generated by the first eight bytes of the number passed */
		/* The arguments are not checked */
