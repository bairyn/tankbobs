...
function c_files_init()
	...
	c_const_set("module_absoluteDir", c_const_get("base_absoluteDir") .. c_const_get("module_dir"), 1)
	c_const_set("module64_absoluteDir", c_const_get("base_absoluteDir") .. c_const_get("module64_dir"), 1)
	c_const_set("module-win_absoluteDir", c_const_get("base_absoluteDir") .. c_const_get("module-win_dir"), 1)
	c_const_set("module64-win_absoluteDir", c_const_get("base_absoluteDir") .. c_const_get("module64-win_dir"), 1)
	c_const_set("jit_absoluteDir", c_const_get("base_absoluteDir") .. c_const_get("jit_dir"), 1)
