...
function st_selected_init()
	...
	gui_addLabel(tankbobs.m_vec2(50, 57), "Spawn mode", nil, 1 / 3) gui_addCycle(tankbobs.m_vec2(75, 57), "Spawn style", nil, st_selected_spawn, {"Alternating", "Blockable"}, spawnPos, 0.5)
