...
function gui_init()
  ...
  --
	...
	c_const_set("scale_scalex", 1 / 4, 1)
	c_const_set("scale_scaley", 1 / 4, 1)
	...
	if c_config_get("client.preview") then
		c_const_set("label_r", 0.2, 1)
		c_const_set("label_g", 0.1, 1)
		c_const_set("label_b", 0.05, 1)
		...
		c_const_set("cycle_r", 0.25, 1)
		c_const_set("cycle_g", 0.05, 1)
		c_const_set("cycle_b", 0.05, 1)
		...
		c_const_set("key_r", 0.75, 1)
		c_const_set("key_g", 0.15, 1)
		c_const_set("key_b", 0.15, 1)
		...
		-- the foreground colors need to contrast against a dark background
